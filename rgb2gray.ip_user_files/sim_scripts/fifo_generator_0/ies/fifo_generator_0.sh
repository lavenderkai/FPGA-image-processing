...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../ip/fifo_generator_0/fifo_generator_0_sim_netlist.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.fifo_generator_0 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.fifo_generator_0 -input simulate.do
}
# Script usage
usage()
{
