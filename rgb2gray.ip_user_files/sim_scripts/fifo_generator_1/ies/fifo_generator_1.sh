...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../ip/fifo_generator_1/fifo_generator_1_sim_netlist.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.fifo_generator_1 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.fifo_generator_1 -input simulate.do
}
# Script usage
usage()
{
